...
class BuoyPresetTest {
  ...
  void tdl025_sectionVolume_matchesManufacturer() {
    ...
    assertEquals(
        0.088, v, 0.020, "TDL-0.25M-S section volume should be near manufacturer 0.088 m³");
  }
  ...
  void tdl030_sectionVolume_matchesManufacturer() {
    ...
    assertEquals(
        0.142, v, 0.020, "TDL-0.30M-S section volume should be near manufacturer 0.142 m³");
  }
  ...
  void surMark_sectionVolume_matchesPresetSW() {
    ...
    assertEquals(expectedM3, v, 0.001, "Sur-Mark Σ section volume should match SW kg / 1000.");
  }
