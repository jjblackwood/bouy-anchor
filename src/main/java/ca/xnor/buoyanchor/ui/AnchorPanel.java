...
public class AnchorPanel extends VBox {
    ...
    private ComboBox<Anchor.Kind> kindCombo;
    private TextField massField;
    private TextField mdfField;
    ...
    public AnchorPanel(SimParams params) {
        ...
        ComboBox<AnchorPreset> presetChooser = new ComboBox<>(
                FXCollections.observableArrayList(AnchorPreset.LIBRARY));
        ...
        holdField = RodePanel.numField(a.holdingFactor.get(), W_HF,   v -> params.anchor.get().holdingFactor.set(v));
