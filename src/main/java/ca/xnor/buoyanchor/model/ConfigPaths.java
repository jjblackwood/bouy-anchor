...
/** OS-appropriate user config directory for bouy-anchor. Subdirectories under this hold
 *  YAML overrides for {@code marks/}, {@code rodes/}, {@code anchors/}, etc. */
public final class ConfigPaths {
    ...
    public static Path marksDir()   { return appConfigDir().resolve("marks"); }
    public static Path rodesDir()   { return appConfigDir().resolve("rodes"); }
    public static Path anchorsDir() { return appConfigDir().resolve("anchors"); }
}
