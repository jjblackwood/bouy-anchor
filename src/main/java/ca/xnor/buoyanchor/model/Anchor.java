...
/**
 * Anchor at the seabed end of the rode. The kind is informational/visual; what matters to the
 * physics is massKg (for both dry-weight and holding-capacity calculations), mdf (in-water weight
 * fraction), and holdingFactor (× weight in N = max horizontal pull before drag).
 */
public final class Anchor {
  ...
  /**
   * No-arg constructor — initialises every field to its declared default. Used by the YAML state
   * loader when reading a saved Anchor that hasn't specified every field.
   */
  public Anchor() {
